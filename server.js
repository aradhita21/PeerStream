...
var flash = require('express-flash-messages');//for flash messages

const HTTP_PORT = 8001
const HTTPS_PORT = 8443; //default port for http is 8443
var CLIENTS = [];
var CLIENTS1 = [];
...
wss.on('connection', function (ws) {
  ws.on('message', function (message) {
    ...
    recv = JSON.parse(message) //converting a JSON object into a normal object
    
    if(recv.state == "disconnected"){ //if a peer disconnects
